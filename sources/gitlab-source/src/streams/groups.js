...
var Groups = /** @class */ (function (_super) {
    ...
    function Groups(config, logger, farosClient) {
    ...
    Groups.prototype.getJsonSchema = function () {
        return require('../../resources/schemas/groups.json');
    };
    Object.defineProperty(Groups.prototype, "primaryKey", {
        get: function () {
            return 'id';
        },
        enumerable: false,
    ...
    Object.defineProperty(Groups.prototype, "cursorField", {
        get: function () {
            return ['updated_at'];
        },
        enumerable: false,
    ...
    Groups.prototype.readRecords = function (syncMode, cursorField, streamSlice, streamState) {
        return __asyncGenerator(this, arguments, function readRecords_1() {
            var gitlab, filter, groups, _i, groups_1, groupPath, group, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        groupPath = groups_1[_i];
                        _a.label = 5;
                    case 5:
                        _a.trys.push([5, 9, , 10]);
                        return [4 /*yield*/, __await(gitlab.getGroup(groupPath))];
                    case 6:
                        group = _a.sent();
                        return [4 /*yield*/, __await(__assign(__assign({}, group), { path: groupPath }))];
                    ...
                    case 9:
                        error_1 = _a.sent();
                        this.logger.error("Error fetching group ".concat(groupPath, ": ").concat(error_1.message));
                        return [3 /*break*/, 10];
                    case 10:
                        _i++;
                        return [3 /*break*/, 4];
