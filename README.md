...
Azure Repos Source | [sources/azurerepos-source](sources/azurerepos-source) | `docker pull farosai/airbyte-azurerepos-source` | [![](https://img.shields.io/docker/v/farosai/airbyte-azurerepos-source?color=blue&label=docker)](https://hub.docker.com/r/farosai/airbyte-azurerepos-source/tags)
