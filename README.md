...
Azure Git Source | [sources/azuregit-source](sources/azuregit-source) | `docker pull farosai/airbyte-azuregit-source` | [![](https://img.shields.io/docker/v/farosai/airbyte-azuregit-source?color=blue&label=docker)](https://hub.docker.com/r/farosai/airbyte-azuregit-source/tags)
