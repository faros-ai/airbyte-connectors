...
Azure Repo Source | [sources/azurerepo-source](sources/azurerepo-source) | `docker pull farosai/airbyte-azurerepo-source` | [![](https://img.shields.io/docker/v/farosai/airbyte-azurerepo-source?color=blue&label=docker)](https://hub.docker.com/r/farosai/airbyte-azurerepo-source/tags)
