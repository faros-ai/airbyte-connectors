...
Bamboo Source | [sources/bamboo-source](sources/bamboo-source) | `docker pull farosai/airbyte-bamboo-source` | [![](https://img.shields.io/docker/v/farosai/airbyte-bamboo-source?color=blue&label=docker)](https://hub.docker.com/r/farosai/airbyte-bamboo-source/tags)
