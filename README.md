...
Spinnaker Source | [sources/spinnaker-source](sources/spinnaker-source) | `docker pull farosai/airbyte-spinnaker-source` | [![](https://img.shields.io/github/v/tag/faros-ai/airbyte-connectors?label=)](https://hub.docker.com/orgs/farosai/repositories)
